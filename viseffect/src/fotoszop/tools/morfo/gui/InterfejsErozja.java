 ...
 * @author kalkan
 */
public class InterfejsErozja extends ToolInterface {
    ...
    public InterfejsErozja() {
        menu = new JMenuItem("Erozja");
        menu.setIcon(this.getResourceMap().getIcon("icons.erosion"));
        menu.addActionListener(this);
        dialog = new ArrayDialog("Erozja", "Wpisz element strukturalny", this, 1);
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (selectedFrame.getPicture().getImage().getType() != BufferedImage.TYPE_BYTE_BINARY) {
            JOptionPane.showMessageDialog(menu, "obrazek nie jest czarno-biały");
            return;
        }
        ...
        morf.erozja(selectedFrame.getPicture().getImage());
