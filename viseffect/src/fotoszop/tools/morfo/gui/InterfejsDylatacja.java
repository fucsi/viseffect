 ...
 * @author kalkan
 */
public class InterfejsDylatacja extends ToolInterface {
    ...
    public InterfejsDylatacja() {
        menu = new JMenuItem("Dylatacja");
        menu.addActionListener(this);
        dialog = new ArrayDialog("Dylatacja", "Wpisz element strukturalny", this, 1);
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        morf.dylatacja(selectedFrame.getPicture().getImage());
