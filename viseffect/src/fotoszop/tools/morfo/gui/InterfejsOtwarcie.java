 ...
 * @author kalkan
 */
public class InterfejsOtwarcie extends ToolInterface {
    ...
    public InterfejsOtwarcie() {
        menu = new JMenuItem("Otwarcie");
        menu.setIcon(this.getResourceMap().getIcon("icons.openup"));
        menu.addActionListener(this);
        dialog = new ArrayDialog("Otwarcie", "Wpisz element strukturalny", this, 1);
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        morf.otwarcie(selectedFrame.getPicture().getImage());
