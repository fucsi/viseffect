 ...
 * @author kalkan
 */
public class Signal2Noise extends ToolInterface {
    ...
    public Signal2Noise() {
        menuItem = new JMenuItem("Signal2Noise");
        menuItem.addActionListener(this);
        dialog = new MyDialog("Signal2Noise Computation", "Chose the original, with and without noise", this);
    ...
    private void signal2Noise(List<BufferedImage> images) {
        long up = 0;
        long down1 = 0, down2 = 0;
        long[] tmp0 = {0, 0, 0};
        long[] tmp1 = {0, 0, 0}, tmp2 = {0, 0, 0};
        ...
        for (int x = 0; x < M; x++) {
            for (int y = 0; y < N; y++) {
                ...
                up += tmp0[0] * tmp0[0] + tmp0[1] * tmp0[1] + tmp0[2] * tmp0[2];
        ...
        error1 = 10.0 * Math.log10((double) up / down1);
        error2 = 10.0 * Math.log10((double) up / down2);
    }
